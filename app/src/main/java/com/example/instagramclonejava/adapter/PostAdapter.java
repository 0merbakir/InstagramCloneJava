...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        holder.recyclerRowBinding.recyclerViewUserEmail.setText(postArrayList.get(position).email);
        holder.recyclerRowBinding.recyclerViewCommwnt.setText(postArrayList.get(position).comment);
